...
class CausalConv1dPrefillTest(unittest.TestCase):
    ...
    def test_short_request_left_padded_from_state(self):
        ...
        # Final state should be [prior[1], 10, 20] — the last K-1=3 logical
        # tokens. logical_idx 0 is prior[2]=9? No wait, the state holds the
        # K-1 most recent tokens BEFORE this batch. So before this batch:
        # ..., prior[0]=7, prior[1]=8, prior[2]=9. Then we append 10, 20.
        # The most-recent K-1 = 3 logical tokens are: 8, 9, 10? No — 9, 10, 20.
        # So final_state should be [9, 10, 20].
